...
class App extends React.Component {
    ...
    sortByPrice() {
        ...
        this.setState({
            activePage: 1,
            page: this.state.filteredInfo.slice((this.state.activePage - 1) * this.state.itemsPerPage, (this.state.activePage) * this.state.itemsPerPage)
        })
    }
    ...
    render() {
        ...
        return ( <
            ...
            /> <
            div className = "main" > < Grid container spacing = {
                2
            }
...

            {
                ...
                totalPosts = {
                    this.state.filteredInfo.length
                }
                paginate = {
                    paginate
                }
